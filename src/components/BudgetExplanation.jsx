        ...
        <div className="glass-panel" style={{
            ...
            <div style={{ textAlign: 'center', marginBottom: '1rem' }}>
                ...
                <p style={{ color: 'var(--text-muted)', fontSize: '1.05rem', maxWidth: '800px', margin: '0 auto', lineHeight: 1.6 }}>
                    ...
                    Az alábbi rövid útmutató segít eligazodni abban, honnan lesz pénze a településnek és hogyan tervezi meg a jövőt.
                </p>
            </div>
            ...
            <div style={{ marginTop: '1rem', padding: '1.5rem', background: 'rgba(0, 0, 0, 0.03)', borderRadius: '1rem', border: '1px solid rgba(0,0,0,0.06)' }}>
                ...
                <p style={{ fontSize: '0.9rem', color: 'var(--text-muted)', lineHeight: 1.6, margin: 0 }}>
                    ...
                    Azonban év közben történhetnek változások (pl. előre nem várt és emiatt nem betervezett kiadások és bevételek), amiket utólagosan, a költségvetés módosítása során rögzíteni kell.
                    Az év végén, a ténylegesen teljesült bevételi és kiadási összegeket tartalmazó végleges listát hívjuk <strong>Zárszámadásnak (Tényadatoknak)</strong>. Az átláthatóság érdekében {config.alapEv - 1}-ig visszamenőleg már a valós Tényadatokat láthatja a kimutatásokban. 
                    A reálisabb pénzügyi helyzetértékelés érdekében a <strong>Közös Önkormányzati Hivatal költségei</strong> az Egyéb Kiadások helyett a Személyi Jellegű Kiadások között szerepelnek, valamint a Működési Bevételek között a <strong>Pénzügyi Műveletek Bevételei (pl. kamatbevételek)</strong> nem szerepelnek!
                </p>
            </div>
